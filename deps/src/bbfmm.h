...
void computeU(double *X1, double *X2, double *X3, double *Y1, double *Y2, double *Y3,
          FUN kernel, int Rrank);
void computeS(double *X1, double *X2, double *X3, double *Y1, double *Y2, double *Y3,
          FUN kernel, int Rrank);
#endif
